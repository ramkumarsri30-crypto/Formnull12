// Analyze all Youform reference screenshots to extract field types + capabilities
import ZAI from 'z-ai-web-dev-sdk';
import fs from 'fs';
import path from 'path';

const dir = '/home/z/my-project/upload/youform-screens/youform screenshot';
const outPath = '/home/z/my-project/scripts/vlm-results.md';
...
async function main() {
  ...
  for (const f of files) {
    ...
    fs.writeFileSync(outPath, `# VLM analysis of Youform reference screenshots\n\n${results.join('\n---\n\n')}`);
  }
